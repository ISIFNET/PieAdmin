@php
    $timestamps = Isifnet\PieAdmin\Widgets\Checkbox::make('timestamps')->inline();
    $timestamps->options([1 => 'Created_at & Updated_at'])->check(1);

    $soft = Isifnet\PieAdmin\Widgets\Checkbox::make('soft_deletes')->inline();
    $soft->options([1 => (trans('admin.scaffold.soft_delete'))]);
    if (old('soft_deletes') != NULL) {
        $soft->check(1);
    }

    $actionCreators = Isifnet\PieAdmin\Widgets\Checkbox::make('create[]')->inline();
                ...
                <div class='form-group'>
                    <button type="button" class="btn btn-sm btn-primary btn-outline text-capitalize"
                            id="add-table-field"><i
                                class="feather icon-plus"></i>&nbsp;&nbsp;{{(trans('admin.scaffold.add_field'))}}
                    </button>
