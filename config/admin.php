   ...
   */
    ...
    */
    'grid' => [
        ...
        'batch_action_class' => Isifnet\PieAdmin\Grid\Tools\BatchActions::class,

        // The global Grid pagination display class.
        'paginator_class' => Isifnet\PieAdmin\Grid\Tools\Paginator::class,

        'actions' => [
            'view' => Isifnet\PieAdmin\Grid\Actions\Show::class,
            'edit' => Isifnet\PieAdmin\Grid\Actions\Edit::class,
            'quick_edit' => Isifnet\PieAdmin\Grid\Actions\QuickEdit::class,
            'delete' => Isifnet\PieAdmin\Grid\Actions\Delete::class,
            'batch_delete' => Isifnet\PieAdmin\Grid\Tools\BatchDelete::class,
        ],

        // The global Grid column selector setting.
        'column_selector' => [
            'store' => Isifnet\PieAdmin\Grid\ColumnSelector\SessionStore::class,
            'store_params' => [
                'driver' => 'file',
            ],
        ],
